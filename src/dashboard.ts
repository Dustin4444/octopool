...
<style>
  ...
  *{box-sizing:border-box}
  ...
  @media (max-width:900px){main{padding:22px 16px 40px}.shell{grid-template-columns:1fr}.tiles{grid-template-columns:repeat(2,minmax(0,1fr))}aside{position:static}.controls{grid-template-columns:minmax(0,1fr) auto;align-items:end}.who{margin-top:0;padding:0 0 0 17px;border-top:0;border-left:1px solid var(--line-soft)}.error{grid-column:1/-1}.bar{grid-template-columns:1fr}.bar>div:last-child{text-align:left}}
  @media (max-width:620px){header{align-items:flex-start}.header-actions{align-items:flex-end;flex-direction:column}.live{height:32px}.shell{gap:14px}.controls{grid-template-columns:1fr}.who{margin-top:15px;padding:15px 0 0;border-left:0;border-top:1px solid var(--line-soft)}.tiles{grid-template-columns:1fr 1fr}.tile{min-height:104px}.panel-head{padding:0 13px}th,td{padding:10px 13px;min-width:105px}table{min-width:620px}}
