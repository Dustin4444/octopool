...
var relayQueryPathPatterns = []*regexp.Regexp{
	...
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/commits/[0-9A-Fa-f]{7,64}/(comments|pulls|branches-where-head|check-runs|check-suites|status)$`),
	...
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/branches/[^/?#]+$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/(tags|languages|contributors|license|topics|forks|stargazers|subscribers|events)$`),
