...
var relayQueryPathPatterns = []*regexp.Regexp{
	...
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/commits/[0-9A-Fa-f]{7,64}/comments$`),
	...
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/branches/[^/?#]+$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/(tags|languages|contributors|license|topics|forks|stargazers|subscribers)$`),
