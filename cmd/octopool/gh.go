...
var relayQueryPathPatterns = []*regexp.Regexp{
	...
	regexp.MustCompile(`^/users/[A-Za-z0-9](?:[A-Za-z0-9-]{0,37}[A-Za-z0-9])?(?:\[bot\]|%5[Bb]bot%5[Dd])?/(repos|orgs|gists|followers|following|events|received_events|keys|gpg_keys)$`),
	regexp.MustCompile(`^/orgs/[^/]+/(repos|events|public_members)$`),
	regexp.MustCompile(`^/orgs/[^/]+/public_members/[^/?#]+$`),
	regexp.MustCompile(`^/gists/[0-9A-Fa-f]+$`),
	regexp.MustCompile(`^/(emojis|meta|licenses|gitignore/templates)$`),
	...
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/commits/[0-9A-Fa-f]{7,64}/(comments|pulls|branches-where-head|statuses|check-runs|check-suites|status)$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/statuses/[0-9A-Fa-f]{7,64}$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/comments/[0-9]+$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/compare/[^/?#]+$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/contents/.+$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/readme(?:/.+)?$`),
	...
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/pulls/[0-9]+/requested_reviewers$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/pulls/[0-9]+/reviews/[0-9]+(?:/comments)?$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/pulls/comments$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/pulls/comments/[0-9]+$`),
	...
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/issues/(comments|events)$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/issues/(comments|events)/[0-9]+$`),
	...
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/branches/[^/?#]+$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/(tags|languages|contributors|license|topics|forks|stargazers|subscribers|deployments|events)$`),
	regexp.MustCompile(`^/networks/[^/]+/[^/]+/events$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/stats/(contributors|commit_activity|code_frequency|participation|punch_card)$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/community/profile$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/git/(blobs|commits|trees)/[0-9A-Fa-f]{7,64}$`),
	regexp.MustCompile(`^/repos/[^/]+/[^/]+/git/(ref|matching-refs)/.+$`),
